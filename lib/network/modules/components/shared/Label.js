...
class Label {
  ...
  _drawText(ctx, selected, x, y, baseline = 'middle') {
    ...
    ctx.font = ((this.nodeOptions.labelItalic) ? 'italic ' : '')+((selected && this.nodeOptions.labelHighlightBold) || (this.nodeOptions.labelBold) ? 'bold ' : '') + fontSize + "px " + this.fontOptions.face;
